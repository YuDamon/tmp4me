...
function M.parse(arg)
   ...
   cmd:option('-dataset',    'seg', 'Options: imagenet | cifar10 | cifar100 | seg')
   ...
   cmd:option('-trainRnn',        'false', 'Train rnn part only')
	------------- Test options ------------------------
   ...
   ---------- Model options ----------------------------------
   cmd:option('-netType',      'segresnet', 'Options: segresnet | resnet | preresnet')
   cmd:option('-depth',        34,       'ResNet depth: 18 | 34 | 50 | 101 | ...', 'number')
   cmd:option('-classNum',      5,       'number of class')
   ...
   cmd:option('-cnnPath',         'none',  'The path to the pretrained cnn model')
   cmd:option('-rnnPath',         'none',  'The path to the pretrained rnn model')
   cmd:option('-nFeatures',       256,     'Number of features extracted by RNN')
   cmd:option('-seqLen',          5,       'Length of sequences fed into RNN')
   cmd:text()
   ...
   opt.trainRnn = opt.trainRnn ~= 'false'
	opt.lastLoss = opt.lastLoss ~= 'false'
